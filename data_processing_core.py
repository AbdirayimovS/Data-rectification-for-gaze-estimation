# SOURCE: https://phi-ai.buaa.edu.cn/Gazehub/Codes/data_processing_core.pdf #
#############################################################################
...
class norm:  
    def __init__(self, center, headrotvec, imsize, camparams, newfocal=960, newdistance=600):
        try:
